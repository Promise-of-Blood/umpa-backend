...
public class CreateMrProductionServicePostCommand {
  ...
  @NotNull final String additionalCostPolicy;
  @NotNull final Integer freeRevisionCount;
  @NotNull final Integer additionalRevisionCost;
  @NotNull final String averageDuration;
  @NotNull final List<String> usingSoftwareList;
  @NotNull final List<String> sampleMrUrls;
}
